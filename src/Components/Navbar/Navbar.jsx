  ...
  return (
    <div className="navbar bg-base-100">
      ...
      <div className="navbar-end pr-2">
        ...
        <input
          className="hidden md:block lg:block pl-9 py-[6px] rounded-3xl me-3 bg-[#150B2B0D] border-0 text-lg max-w-[212px]"
          type="text"
          placeholder="Search"
        />
        <CgProfile className="bg-[#0BE58A] text-lg p-2 rounded-full" />
      </div>
    </div>
  );
};
